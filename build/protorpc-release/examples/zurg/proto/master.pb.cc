...
void protobuf_AssignDesc_master_2eproto() {
  ...
  static const int SlaveHeartbeat_Uname_offsets_[6] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SlaveHeartbeat_Uname, sysname_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SlaveHeartbeat_Uname, nodename_),
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SlaveHeartbeat_Uname, domainname_),
  };
...
void protobuf_AddDesc_master_2eproto() {
  ...
  ::zurg::protobuf_AddDesc_slave_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\014master.proto\022\004zurg\032\032muduo/protorpc2/rp"
    "c2.proto\032\013slave.proto\"\246\004\n\016SlaveHeartbeat"
    "\022\022\n\nslave_name\030\001 \002(\t\022\024\n\014send_time_us\030\002 \002"
    "(\003\022\021\n\thost_name\030\024 \001(\t\022\023\n\013listen_port\030\025 \001"
    "(\005\022\021\n\tslave_pid\030\026 \001(\005\022\025\n\rstart_time_us\030\027"
    " \001(\003\022\025\n\rslave_version\030\030 \001(\t\022\020\n\010env_vars\030"
    "\031 \003(\t\022\017\n\007cpuinfo\030\036 \001(\t\022\017\n\007version\030\037 \001(\t\022"
    "\020\n\010etc_mtab\030  \001(\t\022\016\n\006sysctl\030! \001(\t\022)\n\005una"
    "me\030\" \001(\0132\032.zurg.SlaveHeartbeat.Uname\022\017\n\007"
    "meminfo\030( \001(\t\022\021\n\tproc_stat\030) \001(\t\022\017\n\007load"
    "avg\030* \001(\t\022\021\n\tdiskstats\030+ \001(\t\022\017\n\007net_dev\030"
    ", \001(\t\022\017\n\007net_tcp\030- \001(\t\022#\n\ndisk_usage\0302 \003"
    "(\0132\017.zurg.DiskUsage\032q\n\005Uname\022\017\n\007sysname\030"
    "\001 \002(\t\022\020\n\010nodename\030\002 \002(\t\022\017\n\007release\030\003 \002(\t"
    "\022\017\n\007version\030\004 \002(\t\022\017\n\007machine\030\005 \002(\t\022\022\n\ndo"
    "mainname\030\006 \002(\t2\207\001\n\rMasterService\0228\n\016slav"
    "eHeartbeat\022\024.zurg.SlaveHeartbeat\032\013.rpc2."
    "Empty\"\003\300E\001\022<\n\017appStatusChange\022\027.zurg.App"
    "licationStatus\032\013.rpc2.Empty\"\003\300E\001B2\n\035com."
    "chenshuo.muduo.zurg.protoB\013MasterProto\210\001"
    "\001\220\001\001", 804);
...
SlaveHeartbeat_Uname::SlaveHeartbeat_Uname()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:zurg.SlaveHeartbeat.Uname)
}
...
SlaveHeartbeat_Uname::SlaveHeartbeat_Uname(const SlaveHeartbeat_Uname& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:zurg.SlaveHeartbeat.Uname)
}
...
SlaveHeartbeat_Uname::~SlaveHeartbeat_Uname() {
  // @@protoc_insertion_point(destructor:zurg.SlaveHeartbeat.Uname)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:zurg.SlaveHeartbeat.Uname)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:zurg.SlaveHeartbeat.Uname)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:zurg.SlaveHeartbeat.Uname)
  return false;
#undef DO_
}
...
void SlaveHeartbeat_Uname::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:zurg.SlaveHeartbeat.Uname)
  // required string sysname = 1;
  if (has_sysname()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->sysname().data(), this->sysname().length(),
  ...
  // @@protoc_insertion_point(serialize_end:zurg.SlaveHeartbeat.Uname)
}

::google::protobuf::uint8* SlaveHeartbeat_Uname::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:zurg.SlaveHeartbeat.Uname)
  // required string sysname = 1;
  if (has_sysname()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->sysname().data(), this->sysname().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:zurg.SlaveHeartbeat.Uname)
  return target;
}
...
SlaveHeartbeat::SlaveHeartbeat()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:zurg.SlaveHeartbeat)
}

void SlaveHeartbeat::InitAsDefaultInstance() {
  uname_ = const_cast< ::zurg::SlaveHeartbeat_Uname*>(&::zurg::SlaveHeartbeat_Uname::default_instance());
}
...
SlaveHeartbeat::SlaveHeartbeat(const SlaveHeartbeat& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:zurg.SlaveHeartbeat)
}
...
SlaveHeartbeat::~SlaveHeartbeat() {
  // @@protoc_insertion_point(destructor:zurg.SlaveHeartbeat)
  SharedDtor();
}
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<SlaveHeartbeat*>(16)->f) - \
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 127) {
    ZR_(listen_port_, start_time_us_);
    if (has_slave_name()) {
      if (slave_name_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
        slave_name_->clear();
      }
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:zurg.SlaveHeartbeat)
  for (;;) {
      ...
      case 25: {
        if (tag == 202) {
         parse_env_vars:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            this->env_vars(this->env_vars_size() - 1).data(),
            this->env_vars(this->env_vars_size() - 1).length(),
            ::google::protobuf::internal::WireFormat::PARSE,
            "env_vars");
        } else {
          goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:zurg.SlaveHeartbeat)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:zurg.SlaveHeartbeat)
  return false;
#undef DO_
}
...
void SlaveHeartbeat::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:zurg.SlaveHeartbeat)
  // required string slave_name = 1;
  if (has_slave_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->slave_name().data(), this->slave_name().length(),
  ...
  // @@protoc_insertion_point(serialize_end:zurg.SlaveHeartbeat)
}

::google::protobuf::uint8* SlaveHeartbeat::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:zurg.SlaveHeartbeat)
  // required string slave_name = 1;
  if (has_slave_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->slave_name().data(), this->slave_name().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:zurg.SlaveHeartbeat)
  return target;
}
...
void SlaveHeartbeat::MergeFrom(const SlaveHeartbeat& from) {
  ...
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    ...
    if (from.has_uname()) {
      mutable_uname()->::zurg::SlaveHeartbeat_Uname::MergeFrom(from.uname());
    }
    if (from.has_meminfo()) {
...
static const ::google::protobuf::ServiceDescriptor* MasterService_descriptor_ = NULL;

const ::google::protobuf::ServiceDescriptor* MasterService::descriptor() {
  protobuf_AssignDescriptorsOnce();
  if (MasterService_descriptor_ == NULL)
    MasterService_descriptor_ = ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
        "master.proto")->service(0);
...
void MasterService::slaveHeartbeat(const ::zurg::SlaveHeartbeatPtr&,
                         const ::rpc2::Empty*,
...
void MasterService::appStatusChange(const ::zurg::ApplicationStatusPtr&,
                         const ::rpc2::Empty*,
                         const ::muduo::net::RpcDoneCallback& done) {
  assert(0);
  done(NULL);
...
void MasterService::CallMethod(const ::google::protobuf::MethodDescriptor* method,
  ...
  switch(method->index()) {
    case 0:
      slaveHeartbeat(::google::protobuf::down_pointer_cast< ::zurg::SlaveHeartbeat>(request),
             ::google::protobuf::down_cast<const ::rpc2::Empty*>(responsePrototype),
             done);
      break;
    case 1:
      appStatusChange(::google::protobuf::down_pointer_cast< ::zurg::ApplicationStatus>(request),
             ::google::protobuf::down_cast<const ::rpc2::Empty*>(responsePrototype),
             done);
      break;
    default:
...
const ::google::protobuf::Message& MasterService::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::zurg::SlaveHeartbeat::default_instance();
    case 1:
      return ::zurg::ApplicationStatus::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
MasterService_Stub::MasterService_Stub(::muduo::net::RpcChannel* channel__)
  : channel_(channel__), owns_channel_(false) {}
MasterService_Stub::~MasterService_Stub() {
}

void MasterService_Stub::slaveHeartbeat(const ::zurg::SlaveHeartbeat& request,
                              const ::std::function<void(const ::rpc2::EmptyPtr&)>& done) {
  channel_->CallMethod(descriptor()->method(0),
                       request, &::rpc2::Empty::default_instance(), done);
}
void MasterService_Stub::appStatusChange(const ::zurg::ApplicationStatus& request,
                              const ::std::function<void(const ::rpc2::EmptyPtr&)>& done) {
